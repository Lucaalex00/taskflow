        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BoardId = table.Column<Guid>(type: "uuid", nullable: false),
                    ActiveTaskCount = table.Column<int>(type: "integer", nullable: false),
                    OverdueTaskCount = table.Column<int>(type: "integer", nullable: false),
                    InProgressTaskCount = table.Column<int>(type: "integer", nullable: false),
                    SnapshotAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_load_metrics", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tasks_project_boards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_alert_rules_BoardId_IsEnabled",
                table: "alert_rules",
                columns: new[] { "BoardId", "IsEnabled" });

            migrationBuilder.CreateIndex(
                name: "IX_alerts_BoardId_IsRead",
                table: "alerts",
                columns: new[] { "BoardId", "IsRead" });

            migrationBuilder.CreateIndex(
                name: "IX_load_metrics_BoardId_SnapshotAtUtc",
                table: "load_metrics",
                columns: new[] { "BoardId", "SnapshotAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tasks_BoardId_State",
                table: "tasks",
                columns: new[] { "BoardId", "State" });
